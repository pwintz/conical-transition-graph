classdef TwoModeTransitionGainDigraph < handle
  ...
  % ` runtests TestTwoModeTransitionGainDigraph
  ...
  properties(SetAccess = immutable, GetAccess = protected)
    ...
    conical_partition_1   (1, 1); % ConicalPartition;
    conical_partition_2   (1, 1); % ConicalPartition;
  end % End of private properties block
...
%   end % End static methods block
  ...
  methods
    ...
    % Constructor
    function this = TwoModeTransitionGainDigraph(conical_partition)
